def isPalindrome(s):
    ...
    #The above line check for spaces, punctuation marks and special characters, remove them and then covert the rest of the characters to lower case clean string
